...
// required so a valid zero activation releases the act cache and advances. Before
// the weight_value_valid act-gate it was masked by the (buggy) consume firing
