...
module tb_fe_addr_probe;
    ...
    initial begin
        ...
        // ============================================================
        // W0..W8: base addresses + decay multipliers (annAcc skips W7)
        ...
        cfg_write(32'hFFFF_000C, 32'd0);            // bias_base          = 0 (unused)
        cfg_write(32'hFFFF_0010, 32'd40);           // lut_base_addr      = 40
        ...
        cfg_write(32'hFFFF_0034, 32'h0013_5353);    // M0: thresh_op = 1 (LUT)
        ...
        cfg_write(32'hFFFF_0034, 32'h0023_5353);    // M0: thresh_op = 2 (ABS)
        ...
        cfg_write(32'hFFFF_0034, 32'h0003_5353);    // M0: thresh_op = 0 (RELU)
