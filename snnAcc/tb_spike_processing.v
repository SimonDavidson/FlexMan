...
localparam ACT_SLICE_SZ       = 2;     // 2^2 = 4-bit act slices (1-bit elements, sz=0)
...
initial begin
    ...
    for (mi = 0; mi < 256; mi = mi + 1) begin
        // All activation bits = 1 (all neurons spiking).
        // ACT_SLICE_SZ=2 → 1-bit elements, but the 32-bit word holds
        // 32 spike bits. Set all to 1.
        act_sram[mi]      = 32'hFFFF_FFFF;
