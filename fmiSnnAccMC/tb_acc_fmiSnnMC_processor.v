    ...
    always @(posedge clk) begin
        if (ft_trace_en &&
            ...
            $display("[%0t] FT k=%0d idx=%0d base=%0d memaddr=%0d memdata=0x%08h | cache vld=%b caddr=%0d cbase=%0d | wv=0x%08h vvld=%b vtkn=%b memrd=%b ivld=%b",
                ...
                u_dut.u_spike_processing.weight_gen0.weight_cache.g_line.cache_valid_r,
                u_dut.u_spike_processing.weight_gen0.weight_cache.g_line.cache_addr_r,
                u_dut.u_spike_processing.weight_gen0.weight_cache.g_line.cache_base_addr_r,
