...
wire                      act_data_taken;
// MC: cin index forwarded from act_index_generator to weight_generator,
// and cout index forwarded from weight_generator to syn_curr_update.
wire           [CIN_SZ-1:0] act_index_cin;
wire          [COUT_SZ-1:0] weight_index_cout;
...
// the LAST activation is a non-spike — the dump must terminate the pass
// instead, or the weight generator waits forever (snn0 e2e hang, 2026-06-10).
...
weight_generator #(
   ...
   (
    ...
    .weight_index_cout_o(weight_index_cout), // MC
...
syn_curr_update # (
   ...
   .weight_index_cout_i(weight_index_cout),
